...
def main():
    ...
    model_filename = (
        trained_model_dir
        / f"sb_{model_name}_{ticker}_train_on_validation_dataset_only_default_parameters"
    )
    model_filename = (
        trained_model_dir
        / f"sb_{model_name}_{ticker}_train_on_validation_dataset_only_buy_with_default_parameters"
    )
